...
function Create(props) {
    ...
    const coreContract = useSelector(state => state.walletSlice.contract);
  ...
  return (
    <div className='w-full h-screen flex flex-col justify-start items-center py-8'>
        <h2 className='text-3xl font-semibold mb-6'>Crea tu <span className='text-[#f00]'>NFT</span></h2>
        <div className={`${styles.form}`}>
            <div className='mb-4'>
                <TextField variant='outlined' label='NFT Name' id='nftnameinput' className='mb-3' value={nftData.name} fullWidth onChange={handleChangeName} />
            </div>
            <div className='mb-4'>
                <TextField variant='outlined' label='NFT Description' id='nftdescinput' className='mb-3' value={nftData.description} fullWidth onChange={handleChangeDesc} />
            </div>
            <div className='mb-4'>
                <TextField variant='outlined' disabled label='NFT Author' id='nftauthorinput' className='mb-3' value={nftData.author} fullWidth />
            </div>
            <div className='mb-4'>
                <TextField variant='outlined' label='NFT Royalties' id='nftroyaltyinput' className='mb-3' value={nftData.royalty} type="number" fullWidth onChange={handleChangeRoyal} />
            </div>
            <div className='mb-4'>
            <TextField
